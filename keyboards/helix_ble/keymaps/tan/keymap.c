...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_RBRC, KC_BSLS, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , \
      KC_LCTL,  KC_LGUI,  KC_LALT, KC_LGUI, KC_APP,    LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_APP,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      AD_WO_L, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_LBRC, KC_PIPE, \
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_LPRN, KC_RPRN, KC_F12,  _______, _______, KC_HOME, KC_RO,  _______, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_F12,    KC_DEL, \
   ...
   */
  [_ADJUST] =  LAYOUT( \
      ADV_ID0,   ADV_ID1,   ADV_ID2,   ADV_ID3,   ADV_ID4,   KC_F6,                    ADV_ID0,   ADV_ID1,   ADV_ID2,   ADV_ID3,   ADV_ID4,  KC_F12, \
      DEL_ID0,   DEL_ID1,   DEL_ID2,   DEL_ID3,   DEL_ID4,   _______,                DEL_ID0,   DEL_ID1,   DEL_ID2,   DEL_ID3,   DEL_ID4, KC_DEL, \
      AD_WO_L, ENT_DFU, DELBNDS, _______,   _______,  _______,                   AD_WO_L, ENT_DFU,  DELBNDS, _______,  _______, _______, \
